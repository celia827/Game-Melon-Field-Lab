...
const MOSSWING_CHAPTERS = [
  {
    ...
    physics: { speed: 2.48, speedRamp: .01, gravity: 17.6, flap: 5.95, wind: .04, gapMin: 1.68, gapMax: 1.9, moveAmplitude: .18, moveFrequency: .34, pulseMin: 1.68, pulseAmount: .08, centerRange: 1.2, pattern: ['standard', 'choice', 'bonus', 'moving', 'choice', 'bonus', 'standard', 'standard'], duration: 45, gateCount: 24 }
  },
  {
    ...
    physics: { speed: 2.7, speedRamp: .012, gravity: 18.2, flap: 6.08, wind: .16, gapMin: 1.6, gapMax: 1.82, moveAmplitude: .3, moveFrequency: .42, pulseMin: 1.6, pulseAmount: .06, centerRange: 1.25, pattern: ['standard', 'choice', 'wind', 'bonus', 'moving', 'choice', 'bonus', 'standard'], duration: 60, gateCount: 34 }
  },
  {
    ...
    physics: { speed: 2.58, speedRamp: .011, gravity: 18.1, flap: 6.02, wind: .06, gapMin: 1.54, gapMax: 1.76, moveAmplitude: .2, moveFrequency: .55, pulseMin: 1.54, pulseAmount: .1, centerRange: 1.2, pattern: ['standard', 'choice', 'pulse', 'bonus', 'moving', 'wind', 'choice', 'bonus'], duration: 75, gateCount: 42 }
  },
  {
    ...
    physics: { speed: 2.26, speedRamp: .008, gravity: 17.1, flap: 5.82, wind: .025, gapMin: 1.84, gapMax: 2.04, moveAmplitude: .16, moveFrequency: .22, pulseMin: 1.84, pulseAmount: .04, centerRange: .98, pattern: ['choice', 'moving', 'bonus', 'wind', 'choice', 'standard', 'bonus', 'moving'], duration: 90, gateCount: 46 }
  }
];
...
MOSSWING_CHAPTERS.endless = {
  ...
  scenery: { mode: 'garden', count: 84, direction: [-.2, .06], density: 1 },
  physics: { speed: 2.65, speedRamp: .012, gravity: 18.5, flap: 6.05, wind: 0, gapMin: 1.52, gapMax: 1.52, moveAmplitude: 0, moveFrequency: 0, pulseMin: 1.52, pulseAmount: 0, centerRange: 1.25, pattern: ['standard', 'choice', 'bonus', 'moving', 'standard', 'choice', 'bonus'], duration: Infinity, gateCount: Infinity }
};
